...
// Problem 1
// You want to issue food vouchers for a banquet to everyone who donated more than $100. Make a list of everyone who did.
...
// Problem 2
// You need to determine a start order for the runners. You decide to just go by the order they signed up in. Make a list.

let order = [];
order = runners.map(function(runner) {
    return {'position': runner.id, 'name': runner.first_name + ' ' + runner.last_name};
});
console.log(order);

// Problem 3
// You agreed to match one donation of atleast $250. See if anyone accomplished this.

match = [];
match = runners.some(function(runner) {
